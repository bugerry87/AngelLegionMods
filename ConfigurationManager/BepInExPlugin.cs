...
namespace ConfigurationManager
{
    ...
    public class BepInExPlugin : BaseUnityPlugin
    {
        ...
        public BepInExPlugin()
        {
            ...
            _entryBackgroundColor = Config.Bind("Colors", "EntryBackgroundColor", new Color(0.502f, 0.502f, 0.557f, 0.871f), "Entry background color");
            _fontColor = Config.Bind("Colors", "FontColor", new Color(0.361f, 0.714f, 1f, 1), "Font color");
